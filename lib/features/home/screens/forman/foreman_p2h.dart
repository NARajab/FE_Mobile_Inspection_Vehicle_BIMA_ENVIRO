...
class _ForemanP2hState extends State<ForemanP2h> {
  ...
  Widget _buildCard(BuildContext context, int p2hId, String title, String subtitle, String idVehicle, String date, String role, bool isValidated, String vehicle) {
