...
class p2hLvScreen extends StatefulWidget {
  final int id;
  const p2hLvScreen({super.key, required this.id});

  @override
  _p2hScreenState createState() => _p2hScreenState();
}

class _p2hScreenState extends State<p2hLvScreen> {
  List<List<Map<String, String>>> cardItems = [
    [
      ...
      {'item': 'Tiang bendera 4M (tambang)', 'kbj': 'A'}, 
      {'item': 'BBC minimum 25% dari Cap. Tangki', 'kbj' : 'AA'}, 
      {'item': 'Kebersihan alat', 'kbj': 'A'}, 
      {'item': 'Safety cone 2', 'kbj': 'AA'}, 
      {'item': 'Ganjal 2', 'kbj': 'A'}, 
      {'item': 'Dongkrak', 'kbj': 'A'}, 
      {'item': 'Kunci roda', 'kbj': 'A'}, 
  ...
  void initState() {
    super.initState();
    // Inisialisasi status checklist untuk setiap item inspeksi
