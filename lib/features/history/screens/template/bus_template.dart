...
class BusTemplate extends StatefulWidget {
  final int p2hId;
  final String role;
  ...
  @override
  BusTemplateState createState() => BusTemplateState();
}

class BusTemplateState extends State<BusTemplate> {
  ...
  List<DataGridRow> _buildTableData(Map<String, dynamic> pph) {
    ...
    return [
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Oli power steering'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
            value: aroundUnit['ops'] == true ? 'Baik' : 'Rusak'),
      ]),
      DataGridRow(cells: [
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Semua kaca'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
            value: aroundUnit['sk'] == true ? 'Baik' : 'Rusak'),
      ]),
      DataGridRow(cells: [
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Safety cone (simpan didalam kabin) 2'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Alat pemecah kaca'),
        const DataGridCell<String>(columnName: 'Kode', value: 'A'),
        DataGridCell<String>(
            columnName: 'Kondisi',
            value: inTheCabin['apk'] == true ? 'Baik' : 'Rusak'),
      ]),
      DataGridRow(cells: [
        const DataGridCell<String>(columnName: 'No', value: '3.'),
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
