...
class DumpTruckTemplate extends StatefulWidget {
  ...
  @override
  DumpTruckTemplateState createState() => DumpTruckTemplateState();
}
  ...
  List<DataGridRow> _buildTableData(Map<String, dynamic> pph) {
    ...
    return [
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Semua oli Hydraulic Dump'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Kebersihan accessories safety'),
        const DataGridCell<String>(columnName: 'Kode', value: 'A'),
        DataGridCell<String>(
            columnName: 'Kondisi',
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Tail Gate'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Alarm mundur'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
      ...
      DataGridRow(cells: [
        ...
        const DataGridCell<String>(columnName: 'PIC', value: 'Opr'),
        const DataGridCell<String>(
            columnName: 'Item', value: 'Safety cone (simpan diluar kabin) 2'),
        const DataGridCell<String>(columnName: 'Kode', value: 'AA'),
        DataGridCell<String>(
            columnName: 'Kondisi',
